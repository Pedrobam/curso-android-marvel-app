...
class CharactersLoadMoreStateViewHolder(
    ...
    private val progressBarLoadingMore = binding.progressBarLoadingMore
    private val txvTryAgain = binding.txvTryAgain.also {
    ...
    fun bind(loadState: LoadState) {
        ...
        txvTryAgain.isVisible = loadState is LoadState.Error
    }
